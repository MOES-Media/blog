...
<CodeBlock lang="bash">
  Strapi v5.23.1 🚀 Let's create your new project ... Strapi Creating a new

  application at /workspaces/strapi-plugin-tutorial
</CodeBlock>
...
With that, our Strapi project is fully set up, formatted, and ready to go — a solid foundation for building our custom plugin in the next part of this series. At this point your codebase <a href="https://github.com/MOES-Media/blog/tree/main/code/from-script-to-screen-part-1" target="_blank" rel="noopener noreferrer">should look like this</a>.
